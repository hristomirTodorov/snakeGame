...
(function (SnakeGameSetup) {
    var PlayGame = (function (_super) {
        ...
        PlayGame.prototype.updateCounter = function () {
            ...
            //handle self harm
            for (var key in this.restOfSnake.children) {
        ...
        PlayGame.prototype.eatFood = function (snake, food) {
        ...
        PlayGame.prototype.initialSnake = function () {
            this.restOfSnake = this.game.add.group();
            for (var i = 1; i <= this.snakeLen; i++) {
                this.restOfSnake.create(1000, 1000, 'snakeBody');
            }
        };
